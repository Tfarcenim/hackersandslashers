...
public class AttackSparkCritGenericProvider implements ParticleProvider<SimpleParticleType> {
   ...
   public static void register(RegisterParticleProvidersEvent event) {
      HackersAndSlashers.LOGGER.info("Registering particle: Crit generic");
      event.registerSpriteSet((ParticleType)ModParticles.ATTACK_SPARK_CRIT_GENERIC.get(), AttackSparkCritGenericProvider::new);
   }
}
